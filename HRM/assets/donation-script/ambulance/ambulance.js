...
document.getElementById('donation-message').innerHTML = "just $40 a month towards our Emergency Ambulance Service can save lives in Afghanistan";
function donateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('amount-2').innerHTML = "$300";
        document.getElementById('amount-3').innerHTML = "$17000";
...
function amountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "20";
            document.getElementById('donation-message').innerHTML = "just $20 a month towards our Emergency Ambulance Service can save lives in Afghanistan";
        }
        else if (amount == "2") {
            amount = "40";
            document.getElementById('donation-message').innerHTML = "just $40 a month towards our Emergency Ambulance Service can save lives in Afghanistan";
            ...
            amount = "100";
            document.getElementById('donation-message').innerHTML = "just $100 a month towards our Emergency Ambulance Service can save lives in Afghanistan";
        }
    }
    else {
        if (amount == "1") {
    ...
    if ((amount == "40" && donationType == "monthly") || amount == "300") {
        document.getElementById("amount-2").style.backgroundColor = "#fff";
        document.getElementById("amount-2").style.color = "#000";
    }
