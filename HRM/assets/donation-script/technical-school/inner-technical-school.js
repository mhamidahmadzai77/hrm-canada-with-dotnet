...
document.getElementById('inner-amount').value = "160";
document.getElementById('inner-donation-message').innerHTML = "just $160 a month can sponsor two students at our Technical School in Afghanistan";
function innerDonateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('inner-amount-1').innerHTML = "$60";
        ...
        document.getElementById('inner-donation-message').innerHTML = "towards our Technical School Fund can contribute towards aiding our students ";

    } else {
        donateSwitchElement.style.left = "5px";
        donationType = "monthly";
        document.getElementById('inner-amount-1').innerHTML = "$80";
        document.getElementById('inner-amount-2').innerHTML = "$160";
        document.getElementById('inner-amount-3').innerHTML = "$240";
...
function innerAmountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "80";
            document.getElementById('inner-donation-message').innerHTML = "just $80 a month can sponsor a student at our Technical School in Afghanistan";
        }
        else if (amount == "2") {
            amount = "160";
            document.getElementById('inner-donation-message').innerHTML = "just $160 a month can sponsor two students at our Technical School in Afghanistan";
            ...
            amount = "240";
            document.getElementById('inner-donation-message').innerHTML = "just $240 a month can sponsor three students at our Technical School in Afghanistan ";
        }
    }
    else {
        if (amount == "1") {
    ...
    if ((amount == "160" && donationType == "monthly") || (amount == "100" && donationType == "one off")) {
        document.getElementById("inner-amount-2").style.backgroundColor = "#fff";
        document.getElementById("inner-amount-2").style.color = "#000";
    }
    if ((amount == "240" && donationType == "monthly") || amount == "160") {
