...
document.getElementById('inner-donation-message').innerHTML = "just $20 a month towards our Food Security fund can contribute towards providing fresh bread to those in need worldwide";
function innerDonateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('inner-amount-2').innerHTML = "$60";
        document.getElementById('inner-amount-3').innerHTML = "$200";

        // select default option
        document.getElementById('inner-amount-2').style.backgroundColor = "#fff";
        document.getElementById('inner-amount-2').style.color = "#000";
        document.getElementById('inner-amount').value = "60";
        document.getElementById('inner-donation-message').innerHTML = "towards our Food Security fund can contribute towards providing a food package to a family in need";
...
function innerAmountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "10";
            document.getElementById('inner-donation-message').innerHTML = "just $10 a month towards our Food Security fund can contribute towards providing meals to those in need worldwide";
        }
        else if (amount == "2") {
            amount = "20";
            document.getElementById('inner-donation-message').innerHTML = "just $20 a month towards our Food Security fund can contribute towards providing fresh bread to those in need worldwide";
            ...
            amount = "60";
            document.getElementById('inner-donation-message').innerHTML = "just $60 a month towards our Food Security fund can contribute towards providing a food package to a family in need worldwide";
        }
    }
    else {
        if (amount == "1") {
            amount = "40";
            document.getElementById('inner-donation-message').innerHTML = "towards our Food Security fund can contribute towards providing meals to those in need";
        }
        else if (amount == "2") {
            amount = "60";
            document.getElementById('inner-donation-message').innerHTML = "towards our Food Security fund can contribute towards providing a food package to a family in need";
    ...
    if (amount == "20" || (amount == "60" && donationType == "one off")) {
        document.getElementById("inner-amount-2").style.backgroundColor = "#fff";
        document.getElementById("inner-amount-2").style.color = "#000";
    }
    if ((amount == "60" && donationType == "monthly") || amount == "200") {
    ...
    if (otherValue !== "") {
        ...
        if (!isNaN(value) && value > 0) {
            if (donationType == "one off") {
                addAndRefreshBasket(1, "Food-Security", value);
