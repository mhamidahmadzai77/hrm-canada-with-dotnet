...
document.getElementById('donation-message').innerHTML = "just $30 a month towards our Green Afghanistan project can contribute to planting 5 trees in Afghanistan, every month";
function donateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('amount-1').innerHTML = "$6";
        document.getElementById('amount-2').innerHTML = "$30";
        ...
        document.getElementById('amount-2').style.color = "#000";
        document.getElementById('amount').value = "30";
        document.getElementById('donation-message').innerHTML = "towards our Green Afghanistan project can help plant 5 trees in Afghanistan";
...
function amountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "6";
            document.getElementById('donation-message').innerHTML = "just $6 a month towards our Green Afghanistan project can contribute to planting a tree in Afghanistan, every month";
        }
        else if (amount == "2") {
            amount = "30";
            document.getElementById('donation-message').innerHTML = "just $30 a month towards our Green Afghanistan project can contribute to planting 5 trees in Afghanistan, every month";
            ...
            amount = "60";
            document.getElementById('donation-message').innerHTML = "just $60 a month towards our Green Afghanistan project can contribute to planting 10 trees in Afghanistan, every month";
        }
    }
    else {
        if (amount == "1") {
            amount = "6";
            document.getElementById('donation-message').innerHTML = "towards our Green Afghanistan project can help plant a tree in Afghanistan";
        }
        else if (amount == "2") {
            amount = "30";
            document.getElementById('donation-message').innerHTML = "towards our Green Afghanistan project can help plant 5 trees in Afghanistan";
            ...
            amount = "60";
            document.getElementById('donation-message').innerHTML = "towards our Green Afghanistan project can help plant 10 trees  in Afghanistan";
        }
    }
    $('#amount').val(amount);
    var amountButtons = document.getElementsByClassName('btn-amount');
    ...
    if ((amount == "30" && donationType == "monthly") || amount == "30") {
        document.getElementById("amount-2").style.backgroundColor = "#fff";
        document.getElementById("amount-2").style.color = "#000";
    }
