...
document.getElementById('donation-message').innerHTML = "just $40 a month towards our IGP fund can provide someone with the means to earn for their family";
function donateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('donation-message').innerHTML = "towards our IGP fund can provide someone with the means to earn for their family";
...
function amountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "20";
            document.getElementById('donation-message').innerHTML = " just $20 a month towards our IGP fund can provide someone with the means to earn for their family";
        }
        else if (amount == "2") {
            amount = "40";
            document.getElementById('donation-message').innerHTML = "just $40 a month towards our IGP fund can provide someone with the means to earn for their family";
            ...
            amount = "100";
            document.getElementById('donation-message').innerHTML = "just $100 a month towards our IGP fund can provide someone with the means to earn for their family";
        }
    }
    else {
        if (amount == "1") {
