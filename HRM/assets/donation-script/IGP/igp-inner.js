...
document.getElementById('inner-donation-message').innerHTML = "just £40 a month towards our IGP fund can provide someone with the means to earn for their family";
function innerDonateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('inner-donation-message').innerHTML = "towards our IGP fund can provide someone with the means to earn for their family";
...
function innerAmountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "20";
            document.getElementById('inner-donation-message').innerHTML = "just $20 a month towards our IGP fund can provide someone with the means to earn for their family";
        }
        else if (amount == "2") {
            amount = "40";
            document.getElementById('inner-donation-message').innerHTML = "just $40 a month towards our IGP fund can provide someone with the means to earn for their family";
            ...
            amount = "100";
            document.getElementById('inner-donation-message').innerHTML = "just $100 a month towards our IGP fund can provide someone with the means to earn for their family";
        }
    }
    else {
        if (amount == "1") {
    ...
    if ((amount == "40" && donationType == "monthly") || (amount == "100" && donationType == "one off")) {
        document.getElementById("inner-amount-2").style.backgroundColor = "#fff";
        document.getElementById("inner-amount-2").style.color = "#000";
    }
    if ((amount == "100" && donationType == "monthly") || amount == "200") {
    ...
    if (otherValue !== "") {
        ...
        if (!isNaN(value) && value > 0) {
            if (donationType == "one off") {
                addAndRefreshBasket(11, "IGP", value);
