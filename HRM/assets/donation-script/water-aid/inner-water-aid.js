...
document.getElementById('inner-donation-message').innerHTML = "just $20 a month towards our Water Aid fund can contribute towards providing a water tanker to those in need";
function innerDonateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('inner-amount-2').innerHTML = "$500";
        document.getElementById('inner-amount-3').innerHTML = "$1300";

        // select default option
        document.getElementById('inner-amount-2').style.backgroundColor = "#fff";
        document.getElementById('inner-amount-2').style.color = "#000";
        document.getElementById('inner-amount').value = "500";
        document.getElementById('inner-donation-message').innerHTML = "towards our Water Aid fund can provide a hand pump to a community in need";
...
function innerAmountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "10";
            document.getElementById('inner-donation-message').innerHTML = "just $10 a month towards our Water Aid fund can contribute towards providing drinking water to those in need worldwide";
        }
        else if (amount == "2") {
            amount = "20";
            document.getElementById('inner-donation-message').innerHTML = "just $20 a month towards our Water Aid fund can contribute towards providing a water tanker to those in need";
            ...
            amount = "40";
            document.getElementById('inner-donation-message').innerHTML = "just $40 a month towards our Water Aid fund can contribute towards providing a water well to a community in need";
        }
    }
    else {
        if (amount == "1") {
            amount = "100";
            document.getElementById('inner-donation-message').innerHTML = "towards our Water Aid fund can contribute towards providing water to a whole community";
        }
        else if (amount == "2") {
            amount = "500";
            document.getElementById('inner-donation-message').innerHTML = "towards our Water Aid fund can provide a hand pump to a community in need";
            ...
            amount = "1300";
            document.getElementById('inner-donation-message').innerHTML = "towards our Water Aid fund can provide a community with a water well ";
        }
    }
