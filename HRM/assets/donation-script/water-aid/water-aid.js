...
document.getElementById('donation-message').innerHTML = "just $20 a month towards our Water Aid fund can contribute towards providing a water tanker to those in need";
function donateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('amount-1').innerHTML = "$100";
        document.getElementById('amount-2').innerHTML = "$500";
        ...
        document.getElementById('donation-message').innerHTML = "towards our Water Aid fund can provide a hand pump to a community in need";
        ...
        document.getElementById('amount-3').innerHTML = "$40";
...
function amountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "10";
            document.getElementById('donation-message').innerHTML = "just £10 a month towards our Water Aid fund can contribute towards providing drinking water to those in need worldwide";
        }
        else if (amount == "2") {
            amount = "20";
            document.getElementById('donation-message').innerHTML = "just £20 a month towards our Water Aid fund can contribute towards providing a water tanker to those in need";
            ...
            amount = "40";
            document.getElementById('donation-message').innerHTML = "just £40 a month towards our Water Aid fund can contribute towards providing a water well to a community in need";
        }
    }
    else {
        if (amount == "1") {
            amount = "100";
            document.getElementById('donation-message').innerHTML = "towards our Water Aid fund can contribute towards providing water to a whole community";
        }
        else if (amount == "2") {
            amount = "500";
            document.getElementById('donation-message').innerHTML = "towards our Water Aid fund can provide a hand pump to a community in need";
            ...
            amount = "1300";
            document.getElementById('donation-message').innerHTML = "towards our Water Aid fund can provide a community with a water well";
        }
    }
    $('#amount').val(amount);
    var amountButtons = document.getElementsByClassName('btn-amount');
    ...
    if (amount == "20" || (amount == "500" && donationType == "one off")) {
        document.getElementById("amount-2").style.backgroundColor = "#fff";
        document.getElementById("amount-2").style.color = "#000";
    }
    ...
    if (otherValue !== "") {
        ...
        if (!isNaN(value) && value > 0) {
            if (donationType == "one off") {
                addAndRefreshBasket(2, "Water-Aid", value);
