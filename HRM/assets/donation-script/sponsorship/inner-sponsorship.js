...
document.getElementById('inner-amount').value = "80";
document.getElementById('inner-donation-message').innerHTML = "just $80 a month can sponsor an orphan in Afghanistan";
function innerDonateSwitch() {
    ...
    if (donateSwitchElement.style.left === "5px") {
        ...
        document.getElementById('inner-amount-1').innerHTML = "$240";
        document.getElementById('inner-amount-2').innerHTML = "$960";
        document.getElementById('inner-amount-3').innerHTML = "$1440";

        // select default option
        document.getElementById('inner-amount-2').style.backgroundColor = "#fff";
        document.getElementById('inner-amount-2').style.color = "#000";
        document.getElementById('inner-amount').value = "960";
        document.getElementById('inner-donation-message').innerHTML = "can sponsor an orphan in Afghanistan for a whole year";

    } else {
        donateSwitchElement.style.left = "5px";
        donationType = "monthly";
        document.getElementById('inner-amount-1').innerHTML = "$20";
        document.getElementById('inner-amount-2').innerHTML = "$80";
        document.getElementById('inner-amount-3').innerHTML = "$120";
...
function innerAmountClicked(amount) {
    ...
    if (donateSwitchElement.style.left === "5px") {
        if (amount == "1") {
            amount = "20";
            document.getElementById('inner-donation-message').innerHTML = "just $20 a month can sponsor a student to go to school";
        }
        else if (amount == "2") {
            amount = "80";
            document.getElementById('inner-donation-message').innerHTML = "just $80 a month can sponsor an orphan in Afghanistan";
            ...
            amount = "120";
            document.getElementById('inner-donation-message').innerHTML = "just $120 a month can sponsor a needy widow and her children";
        }
    }
    else {
        if (amount == "1") {
            amount = "240";
            document.getElementById('inner-donation-message').innerHTML = "can sponsor a student to go to school for a whole year";
        }
        else if (amount == "2") {
            amount = "960";
            document.getElementById('inner-donation-message').innerHTML = "can sponsor an orphan in Afghanistan for a whole year";
            ...
            amount = "1440";
            document.getElementById('inner-donation-message').innerHTML = "can sponsor a needy widow and her children for a whole year";
        }
    }
